...
time_timeConvSig = convn(noNanMeanSubFullTrace,fliplr(noNanTimeAvgKern),'valid');
...
time_gamConvSig = convn(noNanMeanSubFullTrace,fliplr(noNanGamAvgKern),'valid');
...
gam_gamConvSig = convn(noNanFilt_fullTrace,fliplr(noNanGamAvgKern),'valid');
