function [fitParameters, score, correlation, gridX, gridY, parameters] = fitGaborToImage_L2(imageToFit, debug, expParams, lambda)
...
if debug
    ...
    function error = doFit(parameters)
        ...
        % SSR =nansum(gabor - nanmean(imageToFit))^2;
        % SST =nansum(imageToFit - nanmean(imageToFit))^2;
        % R2ed = SSR/SST;
