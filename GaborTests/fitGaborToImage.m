function [fitParameters, score, correlation, gridX, gridY, parameters] = fitGaborToImage(imageToFit, debug, expParams, lambda)
...
if debug
    ...
    function error = doFit(parameters)
        ...
        errorImage = nansum(abs(tempImage(:)) .* imagePower(:));
