...
if isunix
    ...
    dirPic = 'synology/adeeti/ecog/images/Gabors/2DFFTMovies/IsoProp/';
elseif ispc
    dirIn = 'Z:/adeeti/GaborTests/IsoProp/';
    dirPic = 'Z:/adeeti/ecog/images/Gabors/2DFFTMovies/IsoProp/';
end
...
for expInd = 2:length(allData)
    ...
    v = VideoWriter([dirPic, info.AnesType(1:3) 'exp', num2str(expInd), 'Interp10.avi']);
