function SuperiorVisualOnly(params, w, angle, cyclespersecond, cpd, gratingsize, duration, TTLParams)
% function DriftDemo2([angle=30][, cyclespersecond=1][, f=0.05][, drawmask=1][, maskStd = 90][, gratingsize=400])
...
%% actual code
movieDurationSecs=duration;   % Abort demo after x amount of seconds.
...
% Commented out bc controlled by numberoftrials
    ...
    % gray=white / 2;
    % end
% End of area controlled by numberoftrials
...
% Calculate parameters of the grating:
    ...
    if TTLParams ~= 0
        lj.toggleFIO(TTLParams); %end pulse
    end
...
%     sca;
    ...
    Screen('FillRect', w, [255 255 0], [0 500 0 500]);
    Screen('Flip', w);
catch
